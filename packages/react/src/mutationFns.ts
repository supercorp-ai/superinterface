export {
  mutationFn as createThreadMessageMutationFn,
  Response as CreateThreadMessageResponse,
} from '@/hooks/threadMessages/useCreateThreadMessage/lib/mutationOptions/mutationFn'
